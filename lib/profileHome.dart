            ...
            SizedBox(
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    children: [
                      (currentUser.email) != null ? Text(currentUser.email.toString(),
                          style: TextStyle(
                              fontSize: size.height * 0.018,
                              fontFamily: 'Coolvetica',
                              fontWeight: FontWeight.w500,
                              color: const Color.fromARGB(140, 255, 255, 255))) : Text('')
                    ],
                  )
                ],
              ),
                                ...
                                actions: [
                                  ...
                                  TextButton(
                                      onPressed: () async {
                                        ...
                                        FirebaseStorage.instance.ref().child(currentUser.email.toString()).delete();
