                                        ...
                                        children: [
                                          Container(
                                            ...
                                            child: Icon(Icons.edit,
                                                size: size.height*0.1, color: Color.fromRGBO(4, 99, 128, 1)),
                                          ),
                                          Container(
                                            width: size.width / 2 -
                                                size.width * 0.05 -
                                            ...
                                            decoration: const BoxDecoration(
                                                color: Color.fromARGB(120, 118, 68, 255),
                                                borderRadius: BorderRadius.only(
                                                    bottomRight: Radius.circular(12),
                                                    bottomLeft: Radius.circular(12))),
                                            padding: const EdgeInsets.all(12),
                                            child: Text("Editar Recursos"),
                                          )
                                        ],
                                      ),
                                    ),
                                        ...
                                        children: [
                                          ...
                                          Container(
                                            width: size.width / 2 -
                                                ...
                                                size.width * 0.05,
                                            decoration: const BoxDecoration(
                                                color: Color.fromRGBO(4, 99, 128, 0.548),
                                                borderRadius: BorderRadius.only(
                                                    bottomRight: Radius.circular(12),
                                                    bottomLeft: Radius.circular(12))),
                                            padding: const EdgeInsets.all(12),
                                        ...
                                        children: [
                                          ...
                                          Container(
                                            width: size.width / 2 -
                                                ...
                                                size.width * 0.05,
                                            decoration: const BoxDecoration(
                                                color: Color.fromARGB(151, 255, 165, 47),
                                                borderRadius: BorderRadius.only(
                                                    bottomRight: Radius.circular(12),
                                                    bottomLeft: Radius.circular(12))),
                                            padding: const EdgeInsets.all(12),
                                        ...
                                        children: [
                                          ...
                                          Container(
                                            width: size.width / 2 -
                                                ...
                                                size.width * 0.05,
                                            decoration: const BoxDecoration(
                                                color: Color.fromARGB(136, 14, 151, 44),
                                                borderRadius: BorderRadius.only(
                                                    bottomRight: Radius.circular(12),
                                                    bottomLeft: Radius.circular(12))),
                                            padding: const EdgeInsets.all(12),
                                        ...
                                        children: [
                                          ...
                                          Container(
                                            width: size.width / 2 -
                                                ...
                                                size.width * 0.05,
                                            decoration: const BoxDecoration(
                                                color: Color.fromARGB(120, 255, 68, 68),
                                                borderRadius: BorderRadius.only(
                                                    bottomRight: Radius.circular(12),
                                                    bottomLeft: Radius.circular(12))),
                                            padding: const EdgeInsets.all(12),
                                        ...
                                        children: [
                                          ...
                                          Container(
                                            width: size.width / 2 -
                                                ...
                                                size.width * 0.05,
                                            decoration: const BoxDecoration(
                                                color: Color.fromARGB(132, 68, 137, 255),
                                                borderRadius: BorderRadius.only(
                                                    bottomRight: Radius.circular(12),
                                                    bottomLeft: Radius.circular(12))),
                                            padding: const EdgeInsets.all(12),
